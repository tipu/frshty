...
_ALLOWED: dict[TicketStatus, set[TicketStatus]] = {
    ...
    TicketStatus.pr_ready:   {TicketStatus.pr_created, TicketStatus.pr_failed},
    TicketStatus.pr_created: {TicketStatus.merged, TicketStatus.in_review},
    TicketStatus.in_review:  {TicketStatus.merged, TicketStatus.pr_created},
    TicketStatus.merged:     set(),
    TicketStatus.pr_failed:  {TicketStatus.pr_ready},
